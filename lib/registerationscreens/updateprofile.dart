...
//                  },
  ...
  void GetUserInformation() async
  {
    ...
    convertDateOfBirth = await shPrefApp.GetClientDateOfBirth();

    print("Before convert date of birth"+convertDateOfBirth);

    _updateName.text = await shPrefApp.GetClientName();
    ...
    _updateCellNumber.text = await shPrefApp.GetClientCellNumber();
    _updatePassword.text = await shPrefApp.GetClientPassword();
  ...
  void UpdateUserInformation() async
  {
    ...
    _clientId = await shPrefApp.GetClientId();
...
//    print(_updatePassword.text);
    ...
    String json = '{"ClientId":"$_clientId","ClientName":"${_updateName.text}","ClientDateOfBirth":"${updateBirthDate}","ClientCellNumber":"${_updateCellNumber.text}","ClientPassword":"${_updatePassword.text}"}';
    ...
    if (response.statusCode == 200 && response.body.toString() == "1")
    {
      ...
      await shPrefApp.SetClientInformation(_clientId , _updateName.text , updateBirthDate , _updateCellNumber.text , _updatePassword.text);
